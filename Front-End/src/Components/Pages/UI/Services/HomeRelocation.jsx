...
const HomeRelocation = () => {
  ...
  useEffect(() => {
    ...
    if (user && user._id) {
      ...
      setFormData((prevData) => ({
        ...
        Name: user.name || "",
        Number: user.number || "",
        Email: user.email || "", // Set Email from localStorage
      }));
    }
    fetchCitiesFrom();
  }, []);
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        const response = await fetch(`${API_BASE_URL}/bookings`, {
          ...
          body: JSON.stringify(formData), // Ensure Email is included in the request body
        });
        ...
        setFormData({
          ...
          Name: formData.Name,
          Email: formData.Email, // Reset Email in formData
        });
    ...
    [formData, isLoggedIn, navigate, validateForm]
  );
  ...
  return (
    <div className="ADD">
      ...
      <div className="image-container">
        <img
          src={process.env.PUBLIC_URL + "/Home-Flex.jpg"}
          alt="Home Relocation"
                ...
                <Form onSubmit={handleSubmit} className="booking-form">
                  ...
                  <Form.Group controlId="formLoad">
                    ...
                    >
                      ...
                      <option value="4 BHK">More Than 4 BHK</option>
                    </Form.Control>
                  </Form.Group>
                  <Button
                    variant="success"
      ...
      <Container className="Text-container">
        <Row className="mt-0">
          <Col>
            <h2>Home Relocation Service</h2>
            <p>
              Whether you are relocating within the city or moving to a new
              location, our home relocation service is designed to make the
              process seamless and hassle-free. With a team of experienced
              professionals, we ensure the safe and efficient transportation of
              your belongings.
            </p>
            <h3>Why Choose Our Service?</h3>
            <ul>
              <li>Professional and reliable movers</li>
              <li>Competitive pricing</li>
              <li>Safe and secure handling of your belongings</li>
              <li>Timely and efficient service</li>
              <li>Customized solutions for your relocation needs</li>
            </ul>
          </Col>
        </Row>
      </Container>
