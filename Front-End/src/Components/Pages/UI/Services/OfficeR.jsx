  ...
  return (
    <div className="ADD">
      <div className="image-container">
        <img
          src={process.env.PUBLIC_URL + "/Office-Relocation.jpg"}
      ...
      <Container className="Text-container">
        <Row className="mt-4">
          <Col>
            ...
            <p>
              Plan a hassle-free and safe office move anywhere in the country
              with our expert packers and movers. We ensure that your office
              relocation is smooth and stress-free, allowing you to focus on
              your business.
            </p>
            <h4>Why Choose Us?</h4>
            <ul>
              <li>
                ...
                team handles your belongings with utmost care.
              </li>
              <li>
              ...
              <li>
                <strong>Comprehensive Insurance:</strong> We provide insurance
                coverage for your items for added peace of mind.
              </li>
              <li>
                <strong>Custom Solutions:</strong> We offer tailored relocation
