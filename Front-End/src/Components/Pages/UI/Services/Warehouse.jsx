  ...
  return (
    <div className="ADD">
      ...
      <div className="image-container">
        <img
          src={process.env.PUBLIC_URL + "/warehouse1.jpg"}
                ...
                <Form onSubmit={handleSubmit} className="booking-form">
                  ...
                  <Form.Group controlId="formLoad">
                    ...
                    <Form.Control
                      ...
                      required
                    >
                      <option value="">Select Ton Type</option>
                      ...
                      <option value="More">More Than 4 Tons</option>
                    </Form.Control>
                  </Form.Group>
                  <Button
                    variant="success"
      ...
      <Container className="Text-container">
        <Row className="mt-4">
          <Col>
            ...
            <p>
              Plan a hassle-free and secure storage solution anywhere in the
              country with our expert warehouse services. We ensure that your
              goods are stored safely and efficiently, giving you peace of mind
